...
search_entities = unified.search_entities
generate_entity_description = unified.generate_entity_description
list_items = unified.list_items
get_item = unified.get_item
manage_item = unified.manage_item
get_logbook = unified.get_logbook
get_statistics = unified.get_statistics
diagnose = unified.diagnose
manage_events = unified.manage_events
manage_notifications = unified.manage_notifications
manage_webhooks = unified.manage_webhooks
get_system_info = unified.get_system_info
get_system_data = unified.get_system_data
get_item_entities = unified.get_item_entities
get_item_summary = unified.get_item_summary
